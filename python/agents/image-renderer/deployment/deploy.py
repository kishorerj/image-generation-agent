...
"""Deployment script for Image Renderer."""
...
from image_renderer.agent import root_agent
import vertexai
...
def create() -> None:
    """Creates an agent engine for Image Renderer."""
